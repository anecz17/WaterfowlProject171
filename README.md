...
[![Open In Collab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/16SJZM2o8r21uOwdbYeKjQd6dMEYfBhXR#scrollTo=e38ESYnPdtkG)
...
The thresholded neural network ended up getting an accuracy of 85%, not bad, I feel like it could have been better considering how different many of the images from a contaminated day looked compared to a uncontaminated day. However, its still not bad, and the convolutional neural net was about the same. The model could have been improved possibly by either adjusting the threshold values, changing the number of threshold values used, changing the activation functions in each layer, or changing the number of layers.
